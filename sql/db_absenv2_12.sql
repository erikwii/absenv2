...
--
-- Host: localhost
-- Generation Time: Feb 22, 2016 at 12:31 PM
...
CREATE TABLE IF NOT EXISTS `enrollments` (
  ...
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique_index` (`kode_seksi`,`noreg`),
...
(1, 103, '2015-09-01', '2016-02-29', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(2, 104, '2016-03-01', '2016-06-10', '0000-00-00 00:00:00', '0000-00-00 00:00:00');
...
(2, 'eka', 'eka.suryana@gmail.com', NULL, '$2y$10$j4t2awUnuMBjwQBARMJBlOnTMlRJRptXejwZu6qXkcyQHza7gQDWC', 'xZlYRkzcu4IOCLnDFS8dHSgVQaqvfJCfDKrThH4RrQhNPi7FfHeD8JDu4qTu', '2015-12-21 14:03:52', '2015-12-21 14:05:07'),
...
(27, 'student2', 'student2@unj.ac.id', 'student', '$2y$10$1vEcPcYgoZAwSaKSkt5NHeDHdGkQbRmb7tUQDnVzKG2pzmN/IGyJO', 'MUSDl0EGKgrHLDEZ0Hmd0dQW0CroWfnPuNlShJad00JVGRsih3RDXM4HJDrd', '2016-01-18 11:08:44', '2016-02-15 14:12:29'),
(28, 'dosen2', 'dosen2@unj.ac.id', 'dosen', '$2y$10$g1Hr2kiyVbfNPAMQ19FMz.CKQigXs9rvYWOhwzEmewJWXnCIQ.lQ6', 'nJ3NenlDdKZ4dG95ZQkoB7mHwpGY57K8TD0UMDjSTe5eKaWglqFvRRwsuFAM', '2016-01-18 23:47:05', '2016-02-15 14:29:50'),
(34, 'admin2', 'admin2@unj.ac.id', 'admin', '$2y$10$h2yLnDPuMmt3cvqlDzFp3.ew6IZGrWGyJA0UtkkBYtkgvTSP0zmQ.', '5835DW0lOcPWegpYSCrdh6KgTrDVYlp6cszzZaLhQLWZCL4WjENn3UFfAoKf', '2016-02-10 15:55:59', '2016-02-12 16:01:34');
